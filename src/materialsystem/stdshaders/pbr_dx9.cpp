...
// STATIC: "EMISSIVE"                   "0..1"
// STATIC: "PARALLAXOCCLUSION"          "0..0"
// STATIC: "WVT"                        "0..1"
// STATIC: "HSV"                        "0..1"
// STATIC: "HSV_BLEND"                  "0..1"
// STATIC: "PARALLAXCORRECT"            "0..1"
// STATIC: "BLENDTINTBYMRAOALPHA"       "0..1"
// STATIC: "PARALLAXDITHER"             "0..0"
// STATIC: "EMISSIVEFRESNEL"            "0..0"
...
float4 main(PS_INPUT i) : COLOR
{
...
#if WVT
	float4 mrao = lerp(tex2D(MRAOTextureSampler, correctedTexCoord), tex2D(MRAO2TextureSampler, correctedTexCoord), i.blend);
#else
...
#if EMISSIVE
#if WVT
	float3 emission = lerp(tex2Dsrgb(EmissionTextureSampler, correctedTexCoord).xyz * g_EmissionScale.xyz, tex2Dsrgb(Emission2TextureSampler, correctedTexCoord).xyz * g_EmissionScale.xyz, i.blend);
#else
	...
	float3 lookupHigh = ENV_MAP_SCALE * tex2Dsrgb(EnvmapSampler, specularReflectionVector).xyz;
	...
	float2 AB = tex2D(BrdfIntegrationSampler, float2(lightDirectionAngle, roughness)).rg;
